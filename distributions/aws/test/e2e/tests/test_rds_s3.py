...
from e2e.utils.utils import (
    ...
    get_mysql_client,
    replace_file_values_and_save_file,
)
...
AWS_SECRETS_MANAGER_OVERLAY_FOLDER = "../../aws-secrets-manager/overlays/configurable-secrets/"
AWS_SECRETS_MANAGER_DEPLOYMENT_PATCH = AWS_SECRETS_MANAGER_OVERLAY_FOLDER + "deployment_patch.yaml"
AWS_SECRETS_MANAGER_SECRETS_MANAGER_PATCH = AWS_SECRETS_MANAGER_OVERLAY_FOLDER + "secrets_manager_patch.yaml"
...
def configure_manifests(cfn_stack, aws_secrets_driver, region):
    ...
    secret_names_replacements = {'rds-secret': stack_outputs["RDSSecretName"], 's3-secret': stack_outputs["S3SecretName"]}
    replace_file_values_and_save_file(AWS_SECRETS_MANAGER_DEPLOYMENT_PATCH, secret_names_replacements, placeholders_only=False)
    replace_file_values_and_save_file(AWS_SECRETS_MANAGER_SECRETS_MANAGER_PATCH, secret_names_replacements, placeholders_only=False)
