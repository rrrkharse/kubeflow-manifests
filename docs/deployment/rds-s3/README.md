...
```shell
export CLUSTER_NAME=<your cluster name> # Ignore if you followed step 3
...
With this information in hand, you can now use either the Amazon RDS console or use the attached [CloudFormation template](/docs/deployment/files/rds.yaml) to deploy your database.
...
Open the AWS Cloudformation management console to create a new stack and upload the attached [CloudFormation template](/docs/deployment/files/rds.yaml).
...
![dashboard](/docs/images/cloudformation-rds-output.png)
